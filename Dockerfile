...
WORKDIR /go/src/github.com/mlvhub/learning-go/microservices-tutorial/consignment-service
...
COPY --from=builder /go/src/github.com/mlvhub/learning-go/microservices-tutorial/consignment-service .
